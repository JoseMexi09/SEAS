    ...
    >-->
            ...
            <input type="text" name="search" id="search" class="form-control form-control-lg rounded-0 border-info" placeholder="Teclee la actividad registrada el ante SAT..." autocomplete="off">
               ...
               <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
				...
				<span>¿Existe compareciente?</span>
				<label for="chkYes">
                <input type="radio" id="chkYes" name="chkPassPort" onclick="activa(); "  value="si" checked/>
                 Si
                </label>
                <label for="chkNo">
                <input type="radio" id="chkNo" name="chkPassPort" onclick="EnableDisableTextBox()" value="no" />
                 No
               </label>
                <hr />
                  ...
                  <div class="button-row d-flex mt-4">
					...
					<button class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" id="next5">Siguiente</button>
					 <!-- y este para prueba-->
					<!--<button class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" >Siguiente</button>-->
                ...
                <div class="multisteps-form__content">
				 ...
				 <div class="button-row d-flex mt-4">
                   ...
                   <!-- <button   class="btn btn-success ml-auto" onclick="return agregarUsuarioNuevo()" >Registar</button>-->
					...
					<button   class="btn btn-success ml-auto" onclick=" return agregar_usuario_fisico()" >Registar</button>
					<!-- ESTE VA A LAS VALIDACIONES-->
					<!--<button   class="btn btn-success ml-auto" id="agregar" >Registar</button>-->
